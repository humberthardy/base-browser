...
PIPELINE_DESC = '''
webrtcbin name=sendrecv stun-server=stun://stun.l.google.com:19302 stun-server=stun://ststun.services.mozilla.com
...
class WebRTCClient:
    ...
    async def connect(self):
        ...
        if self.server.startswith("wss://"):
            ...
            kwargs["ssl"] = sslctx
        self.conn = await websockets.connect(self.server, **kwargs)
